...
const r = spawnSync(
  ...
  [
    ...
    '"node --test pruebas/reglas.test.js pruebas/tarifas.test.js pruebas/descuentos.test.js pruebas/codigoSeguridad.test.js pruebas/viajeNuevo.test.js pruebas/compartidos.test.js pruebas/avisoCalificacion.test.js pruebas/avisosPanel.test.js pruebas/avisosConductor.test.js pruebas/gemelosSolicitar.test.js pruebas/tipoNegocio.test.js pruebas/avisosPasajero.test.js pruebas/suscripcion.test.js pruebas/filtroChat.test.js pruebas/amarres.test.js pruebas/vaciado.test.js"',
  ],
