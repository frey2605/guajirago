...
| Ambientes | **2 en la app de transporte** (`b1c8a63`) **y en el panel** (`0664217` de `guajirago-admin`, 25-sep-2026), los dos compilan por ambiente; aliados sigue con **1**, producción, con las llaves a mano | `node scripts/medir-ambientes.cjs` → transporte 6 de 6, panel 6 de 6, aliados 1 de 6 |
