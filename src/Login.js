    ...
    return (
      <div style={{
        ...
        <div style={{
          ...
          <h1 style={{ fontSize: '52px', color: '#0A0A0A', margin: '0', letterSpacing: '-1px' }}>
            Guajira
          </h1>
          <h1 style={{
            fontSize: '72px',
            background: 'linear-gradient(135deg, #1A3ED4, #0F2498)',
            WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent',
            margin: '0', letterSpacing: '-2px',
          }}>GO</h1>
          <p style={{ color: '#6B7280', fontSize: '12px', letterSpacing: '4px', marginTop: '24px' }}>
  ...
  return (
    <div style={{
      ...
      <img src="/logo192.png" alt="GuajiraGo" style={{
        width: '100px', height: '100px',
        borderRadius: '24px', marginBottom: '24px',
        boxShadow: '0 8px 32px rgba(26, 62, 212, 0.3)',
      }}/>
      ...
      <p style={{ color: '#0A0A0A', fontSize: '18px', fontWeight: '900', margin: '0 0 8px', textAlign: 'center' }}>
      ...
      {esIphone && (
        <div style={{
          background: '#F5F7FA', borderRadius: '20px',
          padding: '20px', width: '100%', marginBottom: '16px',
        }}>
          <p style={{ color: '#0A0A0A', fontSize: '15px', fontWeight: 'bold', margin: '0 0 12px', textAlign: 'center' }}>
            📲 Cómo instalar en iPhone:
          </p>
          <p style={{ color: '#6B7280', fontSize: '13px', margin: '0 0 6px' }}>
            1️⃣ Toca <strong style={{color:'#1A3ED4'}}>↑ Compartir</strong> abajo en Safari
          </p>
          <p style={{ color: '#6B7280', fontSize: '13px', margin: '0' }}>
            2️⃣ Toca <strong style={{color:'#1A3ED4'}}>"Añadir a pantalla de inicio"</strong>
          </p>
        </div>
      )}
