  ...
  return (
    <div style={{ backgroundColor: '#141416', minHeight: '100vh', fontFamily: 'Arial, sans-serif' }}>
      ...
      <div style={{ background: 'linear-gradient(135deg, #1A1A1E, #2A2A2E)', padding: '12px 20px', display: 'flex', alignItems: 'center', gap: '16px' }}>
        ...
        <h2 style={{ color: '#FFFFFF', margin: '0', fontSize: '20px' }}>Pedir mandado 📦</h2>
      </div>
      <div style={{ padding: '12px 20px 24px' }}>
        ...
        <p style={{ color: '#FFFFFF', fontSize: '11px', letterSpacing: '2px', margin: '4px 0 8px' }}>DATOS DEL ENVÍO</p>
        <div style={{ background: '#1A1A1E', borderRadius: '14px', padding: '10px 14px', marginBottom: '10px', display: 'flex', alignItems: 'center', gap: '10px' }}>
          <span style={{ fontSize: '18px' }}>📦</span>
          <input value={queEnvia} onChange={e => setQueEnvia(e.target.value)} placeholder="¿Qué envías? (ej: una caja)" style={{ background: 'none', border: 'none', outline: 'none', color: '#FFFFFF', fontSize: '16px', width: '100%' }} />
        </div>
        <div style={{ background: '#1A1A1E', borderRadius: '14px', padding: '10px 14px', marginBottom: '10px', display: 'flex', alignItems: 'center', gap: '10px' }}>
          <span style={{ fontSize: '18px' }}>🙋</span>
          <input value={recibeNombre} onChange={e => setRecibeNombre(e.target.value.toUpperCase())} placeholder="NOMBRE DE QUIEN RECIBE" style={{ background: 'none', border: 'none', outline: 'none', color: '#FFFFFF', fontSize: '16px', width: '100%', textTransform: 'uppercase' }} />
        </div>
        <div style={{ background: '#1A1A1E', borderRadius: '14px', padding: '10px 14px', marginBottom: '10px', display: 'flex', alignItems: 'center', gap: '10px' }}>
          <span style={{ fontSize: '18px' }}>📞</span>
          <input value={recibeTel} onChange={e => setRecibeTel(e.target.value.replace(/\D/g, '').slice(0, 10))} placeholder="Teléfono (10 números)" type="tel" inputMode="numeric" maxLength={10} style={{ background: 'none', border: 'none', outline: 'none', color: '#FFFFFF', fontSize: '16px', width: '100%' }} />
        </div>
        <div style={{ background: '#1A1A1E', borderRadius: '14px', padding: '10px 14px', marginBottom: '16px', display: 'flex', alignItems: 'center', gap: '10px' }}>
          <span style={{ fontSize: '18px' }}>📝</span>
          <input value={notaEnvio} onChange={e => setNotaEnvio(e.target.value)} placeholder="Nota para el domiciliario (ej: dejar en portería)" style={{ background: 'none', border: 'none', outline: 'none', color: '#FFFFFF', fontSize: '16px', width: '100%' }} />
        </div>
