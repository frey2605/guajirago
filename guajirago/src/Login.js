...
function Login({ onEntrar }) {
    ...
    return (
      <div style={{
        ...
        <h1 style={{
          ...
          margin: '0', fontFamily: 'Arial Black, sans-serif',
  ...
  return (
    <div style={{
        ...
        <div style={{
          ...
          <input
            ...
            style={{
              ...
              color: '#FFFFFF', fontSize: '16px', width: '100%',
            }}
          />
        </div>
      )}
      ...
      <button onClick={() => onEntrar(tipo)} style={{
        ...
        {modo === 'login' ? 'Entrar a GuajiraGo' : 'Crear cuenta'}
      </button>
